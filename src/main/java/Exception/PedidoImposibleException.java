...
/**
*<br>Clase padre de las excepciones FaltaDeChofer,FaltaDeVehiculo,PedidoInchoerente. Se extiende de la clase Exception
...
public class PedidoImposibleException extends Exception{
    ...
    /**
     *<br>
     *Metodo que representa la excepcion en la que no se pueda atender el pedido por algun motivo como falta de choferes,vehiculos o que el pedido sea inconmpatible con el servicio brindado
